from Hybridization.BiLSTM_Inference import BiLSTM
from Hybridization.BERT_Inference import Bert_Classifier
from Hybridization.GPT2_Inference import GPT2
...
class LGB:
    ...
    def predict(self, text):
        ...
        c, avg_pred = self.bert.predict(text)

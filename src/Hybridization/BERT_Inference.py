...
class Bert_Classifier:
    ...
    def __init__(self, max_seq_len, lr):
        ...
        self.bert_ckpt_dir = os.path.join(
            _ROOT, "BERT_Fake_News_Classification", '.model', 'uncased_L-12_H-768_A-12')
        ...
        self.lr = lr
        self.bert_weight = os.path.join(
            _ROOT, "BERT_Fake_News_Classification", 'pretrained_weights', 'bert_news.h5')
...
if __name__ == "__main__":
    ...
    obj = Bert_Classifier(max_seq_len=300, lr=1e-5)

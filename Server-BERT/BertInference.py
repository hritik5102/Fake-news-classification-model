...
class Bert_Classifier:
    ...
    def __init__(self, max_seq_len, lr):
        ...
        self.bert_ckpt_dir = "Models/BERT_Fake_News_Classification/.model/uncased_L-12_H-768_A-12"
        ...
        self.lr = lr
        self.bert_weight = "Models/BERT_Fake_News_Classification/pretrained_weights/bert_news.h5"
